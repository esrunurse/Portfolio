    ...
    <header className=" bg-Blue900 min-h-screen flex items-center">
      <div className="ml-40 h-full flex pr-20">
        <div className="flex flex-col justify-around h-[50vh] w-full relative top-[92px] left-32">
          ...
          <button className="bg-Purple w-fit mt-12 text-[3vh] font-normal text-white px-10 py-2 uppercase shadow-lg rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:brightness-110 duration-300">
            hire me
          </button>
        </div>

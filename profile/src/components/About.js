...
function About() {
  ...
  return (
    <section
      id="about"
      className="bg-Blue900 h-full flex items-center w-full justify-center fold:py-0 fold:px-4 md:py-16 md:px-0"
    >
      <div className="flex justify-between w-full md:flex-row lg:px-[15vw] md:px-[10vw] fold:flex-col ">
        <div className="md:w-[40vw] fold:w-full fold:py-6 md:py-0">
          <h1 className="text-white text-center font-bold fold:text-lg fold:my-6 md:text-4xl md:my-12">
            A Bit About Me
          </h1>
        ...
        <div className="pb-12 bg-white fold:ml-0 md:ml-14 fold:w-full md:w-[35vw]">
          <h1 className="text-Blue900 z-50 text-center font-bold fold:text-lg fold:my-6 md:text-4xl md:my-12">
            Skills
          </h1>
          <div className="flex justify-evenly lg:flex-row md:flex-col md:pl-20">
